...
class DealController extends Controller
{
    ...
    public function AddDeal(Request $request)
    {
        ...
        $deal = DB::table('store_products')
            ...
            ->join('product', 'product_varient.product_id', '=', 'product.product_id')
            ->select('product_varient.varient_quantity', 'product_varient.unit', 'product_varient.varient_id', 'product.product_name')
            ->groupBy('product_varient.varient_quantity', 'product_varient.unit', 'product_varient.varient_id', 'product.product_name')
