...
class CategoryController extends Controller
{
    ...
    public function oneapi(Request $request)
    {
        ...
        $deal_pssss = DB::table('deal_product')
            ...
            ->join('product', 'product_varient.product_id', '=', 'product.product_id')
            ->select('store.del_range', 'store_products.store_id', 'store_products.quantity', 'deal_product.deal_price as price', 'product_varient.varient_image', 'product_varient.varient_quantity', 'product_varient.unit', 'store_products.mrp', 'product_varient.description', 'product.product_name', 'product.product_image', 'product_varient.varient_id', 'product.product_id', 'deal_product.valid_to', 'deal_product.valid_from', 'product.type')
            ->groupBy('store.del_range', 'store_products.store_id', 'store_products.quantity', 'deal_product.deal_price', 'product_varient.varient_image', 'product_varient.varient_quantity', 'product_varient.unit', 'store_products.mrp', 'product_varient.description', 'product.product_name', 'product.product_image', 'product_varient.varient_id', 'product.product_id', 'deal_product.valid_to', 'deal_product.valid_from', 'product.type')
        ...
        $topsellings = DB::table('store_products')
            ...
            ->Leftjoin('deal_product', 'product_varient.varient_id', '=', 'deal_product.varient_id')
            ->select('store_products.store_id', 'store_products.quantity', 'product_varient.varient_id', 'product.product_id', 'product.product_name', 'product.product_image', 'product_varient.description', 'store_products.price', 'store_products.mrp', 'product_varient.varient_image', 'product_varient.unit', 'product_varient.varient_quantity', 'product.type', DB::raw('count(store_orders.varient_id) as count'))
            ->groupBy('store_products.store_id', 'store_products.quantity', 'product_varient.varient_id', 'product.product_id', 'product.product_name', 'product.product_image', 'product_varient.description', 'store_products.price', 'store_products.mrp', 'product_varient.varient_image', 'product_varient.unit', 'product_varient.varient_quantity', 'product.type')
            ->where('store_products.store_id', $store_id)
            ->where('deal_product.deal_price', NULL)
            ->where('store_products.price', '!=', NULL)
        ...
        foreach ($catt as $storee) {
            ...
            $cat[] = array('cat_id' => $storee->cat_id, 'cat_title' => $storee->title, 'description' => $storee->description, 'products' => $prodddu);
        }
        ...
        $message = array('status' => '1', 'message' => 'Homepage data', 'banner' => $banner, 'second_banner' => $secbanner, 'top_cat' => $topsix, 'recentselling' => $recent_selling, 'topselling' => $top_selling, 'dealproduct' => $deal, 'whatsnew' => $whatsnew, 'spotlight' => $spotlight, 'category' => $cat);
    ...
    public function cat_product(Request $request)
    {
        ...
        if ($filter1 != NULL) {
            $prodsssss = DB::table('store_products')
                ...
                ->select('store_products.store_id', 'store_products.quantity', 'product_varient.varient_id', 'product.product_id', 'product.product_name', 'product.product_image', 'product_varient.description', 'store_products.price', 'store_products.mrp', 'product_varient.varient_image', 'product_varient.unit', 'product_varient.varient_quantity', 'product.type', DB::raw('100-((store_products.price*100)/store_products.mrp) as discountper'), DB::raw('sum(IFNULL(product_rating.rating,0))/count(IFNULL(product_rating.rating,0)) as avgrating'))
                ->groupBy('store_products.store_id', 'store_products.quantity', 'product_varient.varient_id', 'product.product_id', 'product.product_name', 'product.product_image', 'product_varient.description', 'store_products.price', 'store_products.mrp', 'product_varient.varient_image', 'product_varient.unit', 'product_varient.varient_quantity', 'product.type', 'product_rating.rating')
                ->where('product.cat_id', $cat_id)
                ->where('store_products.store_id', $store_id)
                ->where('store_products.price', '!=', NULL)
                ->where('product.hide', 0)
    ...
    public function dealproduct(Request $request)
    {
        ...
        if ($filter1 != NULL) {
            $deal_pssss = DB::table('deal_product')
                ...
                ->select('store_products.store_id', 'store_products.quantity', 'product_varient.varient_id', 'product.product_id', 'product.product_name', 'product.product_image', 'product_varient.description', 'deal_product.deal_price as price', 'store_products.mrp', 'product_varient.varient_image', 'product_varient.unit', 'product_varient.varient_quantity', 'product.type', DB::raw('100-((store_products.price*100)/store_products.mrp) as discountper'), DB::raw('sum(IFNULL(product_rating.rating,0))/count(IFNULL(product_rating.rating,0)) as avgrating'), 'deal_product.valid_to', 'deal_product.valid_from')
            ...
            if ($prod1 != NULL) {
                ...
                foreach ($prod1 as $prods) {
                    ...
                    $app = DB::table('store_products')
                        ->join('product_varient', 'store_products.varient_id', '=', 'product_varient.varient_id')
                        ->Leftjoin('deal_product', 'product_varient.varient_id', '=', 'deal_product.varient_id')
                        ->select('store_products.store_id', 'store_products.quantity', 'product_varient.varient_id', 'product_varient.description', 'store_products.price', 'store_products.mrp', 'product_varient.varient_image', 'product_varient.unit', 'product_varient.varient_quantity', 'product_varient.weight', 'deal_product.deal_price', 'deal_product.valid_from', 'deal_product.valid_to')
                        ->where('store_products.store_id', $store_id)
                        ->whereIn('product_varient.product_id', $apps)
                        ->where('store_products.price', '!=', NULL)
                        ->where('product_varient.approved', 1)
