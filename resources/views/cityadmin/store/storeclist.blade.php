...
<div class="card-header card-header-primary">
    <div class="row">
        ...
        <div class="col-md-6">
            <a href="{{route('cityad-storeadd')}}" class="btn btn-primary p-1 ml-auto" style="width:15%;float:right;padding: 3px 0px 3px 0px;">{{ __('keywords.Add')}}</a>
        </div>
    </div>
</div>
          ...
          @foreach($city as $cities)
            <tr>
                ...
                <td class="td-actions text-center">
                    <a href="{{route('cityad-storedit', $cities->id)}}" button type="button" class="btn btn-success"><i class="fa fa-edit"></i></a>
                    <a href="{{route('cityad-storedelete', $cities->id)}}" button type="button" class="btn btn-danger" onClick="return confirm('Are you sure you want to permanently remove this Store.This store may have orders Please check its panel.')" rel="tooltip" >
...
<div class="modal fade" id="exampleModal1{{$cities->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="container">
        ...
        <div class="material-datatables">
            ...
            <table id="datatableDefault" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%" data-background-color="purple">
                <tbody>
                    <tr>
                        <td colspan="3">
                            <table class="table">
