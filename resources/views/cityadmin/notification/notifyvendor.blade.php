...
<div class="container-fluid">
 @if (count($errors) > 0)
   ...
   @endif
 @endif
    <form action="{{route('cityad-send_note2vendor')}}" method="post" enctype="multipart/form-data">   
        {{csrf_field()}}
        <div class="form-group">
          <label for="exampleInputName1">{{ __('keywords.Send Notification to Store')}}<sup>*</sup></label>
