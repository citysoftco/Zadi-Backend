    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="{{route('store_dboy_orders',$d_boys->ad_dboy_id)}}" rel="tooltip" class="btn btn-primary">
    	...
    	<div class="modal-dialog" role="document">
    		<div class="modal-content">
    			<div class="modal-header">
    				<h5 class="modal-title" id="exampleModalLabel"><b>{{$cities->boy_name}} {{ __('keywords.Profile')}}</b> (@if($cities->status==1)
