                         ...
                         @if(count($total_earnings)>0)
                          ...
                          @foreach($total_earnings as $total_earning)
                            <tr>
                                ...
                                <td>{{$total_earning->{{ __('keywords.Remaining')}}}}</td>
                                <td class="td-actions text-center">
                                    @if($total_earning->{{ __('keywords.Remaining')}} == 0)
        			...
        			<div class="row">
                      ...
                      <div class="col-md-6" align="center">
                        ...
                        <label>{{ __('keywords.Enter Amount')}}</label>        
        		     	<input class="form-control" type="number" min="10" step="0.01" value="{{$total_earning->{{ __('keywords.Remaining')}}}}" step ="0.01" max="{{$total_earning->{{ __('keywords.Remaining')}}}}"  name="amt"/>
        			</div>
