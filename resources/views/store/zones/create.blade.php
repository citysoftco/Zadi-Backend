            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title">{{ __('keywords.Add Zone') }}</h4>
                        <form class="forms-sample" action="{{ route('store-zones.store') }}"
...
<script src="https://polyfill.io/v3/polyfill.min.js?features=default"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key={{config('settings.map_api_key')}}&libraries=drawing,places&v=3.45.8"></script>
...
<script>
        ...
        var myLatlng = { lat: 15.5007, lng:32.5599 };
