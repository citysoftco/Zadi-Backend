...
@section('content')
                                    ...
                                    @foreach ($ord as $ords)
                                        <tr>
                                            ...
                                            <td><button type="button" class="btn btn-danger" data-toggle="modal"
                                                    data-target="#exampleModal2{{ $ords->cart_id }}">Cancel</button></td>
    ...
    <!--/////////reject orders///////////-->
    @foreach ($ord as $ords)
        <div class="modal fade" id="exampleModal2{{ $ords->cart_id }}" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">{{ __('keywords.Cancel Orders') }}
                            (<b>{{ $ords->cart_id }}</b>)
                        </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                    ...
                    <!--//form-->
                    <form class="forms-sample" action="{{ route('admin_reject_order', $ords->cart_id) }}" method="post"
