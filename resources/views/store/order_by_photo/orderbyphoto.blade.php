            ...
            <div class="col-md-5">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <div class="col-md-12" align="center"><a target="_blank" rel="noopener noreferrer" href="{{$url_aws.$u->list_photo}}"><img src="{{$url_aws.$u->list_photo}}" style="width:200px !important"></a></div>
