 ...
 <div id="sidebar" class="app-sidebar">
     ...
     <div class="app-sidebar-content" data-scrollbar="true" data-height="100%">
         ...
         <div class="menu">
             ...
             <div class="menu-header">{{ __('keywords.Items') }} {{ __('keywords.Management') }}</div>
             <div
                 class="menu-item has-sub {{ request()->is('store/product/*') ? 'active' : '' }} {{ request()->is('store/stproducts/*') ? 'active' : '' }} 
                 ...
                 <a href="#" class="menu-link">
                     ...
                     <span class="menu-text">{{ __('keywords.Product') }} {{ __('keywords.Management') }} </span>
             ...
             <div class="menu-item {{ request()->is('store/st/product/*') ? 'active' : '' }}">
                 <a href="{{ route('storeproductlist') }}" class="menu-link">
                     ...
                     <span class="menu-text">{{ __('keywords.Product') }} {{ __('keywords.Requests') }}</span>
                 </a>
             </div>
             <div class="menu-header">{{ __('keywords.Banner') }} {{ __('keywords.Management') }}</div>
             ...
             <div class="menu-header">{{ __('keywords.Order') }} {{ __('keywords.Management') }}</div>
             <div
                 class="menu-item has-sub {{ request()->is('store/store/all_orders') ? 'active' : '' }}
                 ...
                 <div class="menu-submenu">
                     ...
                     <div
                         class="menu-item {{ request()->is('store/store/out_for_delivery_orders') ? 'active' : '' }}">
             ...
             <div class="menu-header">{{ __('keywords.Delivery') }} {{ __('keywords.Management') }}</div>
             <div
                 class="menu-item has-sub {{ request()->is('store/d_boy/*') ? 'active' : '' }}
             ...
             <div
                 ...
                 <div class="menu-submenu">
                     ...
                     <div
                         class="menu-item {{ request()->is('store/item-sales-report/last-30-days') ? 'active' : '' }}">
