            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        ...
                        <form class="forms-sample" action="{{ route('storeAddNewProduct') }}" method="post"
                            ...
                            {{-- <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control">
                                        <option disabled selected>{{ __('keywords.Select') }} {{ __('keywords.Type') }}
                                        </option>
                        ...
                        <div class="row"> --}}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    {{-- <label class="bmd-label-floating">{{ __('keywords.Quantity') }}</label> --}}
                                    <label class="bmd-label-floating">{{ __('keywords.Quantity') }}</label>
                                    <input type="number" name="varient_quantity" class="form-control"
                                        value="{{ old('varient_quantity') }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
