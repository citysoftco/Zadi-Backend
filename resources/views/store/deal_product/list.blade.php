                ...
                <div class="card">
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('AddDeal') }}" class="btn btn-primary p-1 ml-auto"
                                ...
                                @if (count($deal_p) > 0)
                                    ...
                                    @foreach ($deal_p as $deal)
                                        <tr>
                                            ...
                                            <td>{{ $deal->product_name }} ({{ $deal->weight }}{{ $deal->unit }})</td>
                                            ...
                                            <td class="td-actions text-right">
                                                <a href="{{ route('EditDeal', $deal->deal_id) }}" rel="tooltip"
                                                    class="btn btn-success">
                                                    <i class="material-icons">edit</i>
                                                </a>
                                                <a href="{{ route('DeleteDeal', $deal->deal_id) }}"
                                                    onClick="return confirm('Are you sure you want to remove this Deal Product.')"
