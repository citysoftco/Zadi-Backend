                                        ...
                                        <tr>
                                            ...
                                            @if ($user->is_verified == 0)
                                                <td class="td-actions text-center" style="color:red"><i
                                                        class="fa fa-times-circle" style="color:red"></i></td>
                                            @else
                                                <td class="td-actions text-center" style="color:green"><i
        ...
        <div class="modal fade" id="exampleModal1{{ $user->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <br>
                    <!--//form-->
                    <form class="forms-sample" action="{{ route('usr_recharge', $user->id) }}" method="post"
                        enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                            ...
                            <div class="col-md-6" align="center">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" min="10" step="0.01"
                                        value="0" step="0.01" name="amt" />
                                </div>
                                <button type="submit"
