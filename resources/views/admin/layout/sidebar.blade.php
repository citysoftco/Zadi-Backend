     ...
     <div id="sidebar" class="app-sidebar">
         ...
         <div class="app-sidebar-content" data-scrollbar="true" data-height="100%">
             ...
             <div class="menu">
                 ...
                 <div class="menu-item {{ request()->is('subscription-plans/*') ? 'active' : '' }}">
                 ...
                 <div
                     class="menu-item has-sub {{ request()->is('stores/cancelled/orders') ? 'active' : '' }}
                     ...
                     <div class="menu-submenu">
                         <div class="menu-item {{ request()->is('report/item_sale/*') ? 'active' : '' }}">
                             <a href="{{ route('item_sale_rep') }}" class="menu-link">
                                 <span class="menu-text">{{ __('keywords.Item Requirement') }}
                                     ({{ __('keywords.Day-Wise') }}</span>
                             </a>
                         </div>
                         <div class="menu-item {{ request()->is('report/total-item-sales/*') ? 'active' : '' }}">
                             <a href="{{ route('admin_reqforthirty') }}" class="menu-link">
                                 <span class="menu-text">{{ __('keywords.Item Sales Report') }}
     ...
     <div id="sidebar" class="app-sidebar">
         ...
         <div class="app-sidebar-content" data-scrollbar="true" data-height="100%">
             ...
             <div class="menu">
                 ...
                 @endif
                 @if ($admin->membership == 1 || $admin->id == 1 || $admin->tax == 1 || $admin->settings == 1)
                     <div class="menu-header">{{ __('keywords.Settings') }}</div>
                 @endif
                 @if ($admin->settings == 1)
                     <div class="menu-item {{ request()->is('global_settings') ? 'active' : '' }}">
                 ...
                 @endif
                 @if ($admin->product == 1 || $admin->category == 1)
                     <div class="menu-header">{{ __('keywords.Categories & Products') }}</div>
                 @endif
                 @if ($admin->category == 1)
                     <div
                 ...
                 @endif
                 @if ($admin->payout == 1 || $admin->store == 1)
                     <div class="menu-header">{{ __('keywords.Vendors') }}</div>
                 @endif
                 @if ($admin->store == 1)
                     <div
                         ...
                         <div class="menu-submenu">
                             ...
                             <div
                                 class="menu-item {{ request()->is('stores/waiting_for_approval/*') ? 'active' : '' }}">
                                 <a href="{{ route('storeapprove') }}" class="menu-link">
                                     <span class="menu-text">{{ __('keywords.Store Approval') }}</span>
                                 </a>
                             </div>
                 ...
                 @if ($admin->orders == 1)
					...
					{{ request()->is('store/missed/orders') ? 'active' : '' }}">
                         ...
                         <div class="menu-submenu">
                             ...
                             <div
                                 class="menu-item {{ request()->is('admin/out_for_delivery_orders') ? 'active' : '' }}">
                                 <a href="{{ route('admin_out_orders') }}" class="menu-link">
                                     <span class="menu-text">{{ __('keywords.Out For Delivery orders') }}</span>
                                 </a>
                             </div>
                             <div
                                 class="menu-item {{ request()->is('admin/payment_failed_orders') ? 'active' : '' }}">
                                 <a href="{{ route('admin_failed_orders') }}" class="menu-link">
                                     <span class="menu-text">{{ __('keywords.Payment Failed orders') }}</span>
                                 </a>
                             </div>
                 ...
                 @endif
                 @if ($admin->area == 1 || $admin->delivery_boy == 1)
                     <div class="menu-header">{{ __('keywords.Delivery Settings') }}</div>
                 @endif
                 @if ($admin->delivery_boy == 1)
                     <div
                         ...
                         <div class="menu-submenu">
                             ...
                             <div
                                 class="menu-item {{ request()->is('set_delivery_boy_incentive') ? 'active' : '' }}">
                                 <a href="{{ route('driverinc') }}" class="menu-link">
                 ...
                 @if ($admin->notification == 1)
                     ...
                     <div class="menu-item has-sub {{ request()->is('list/notification/*') ? 'active' : '' }}">
                         <a href="#" class="menu-link">
                             ...
                             <span class="menu-text">{{ __('keywords.Old Notifications') }}</span>
                             <span class="menu-caret"><b class="caret"></b></span>
                         </a>
                         <div class="menu-submenu">
                             <div
                                 class="menu-item {{ request()->is('list/notification/list/user') ? 'active' : '' }}">
                                 <a href="{{ route('usernotlist') }}" class="menu-link">
                                     <span class="menu-text">{{ __('keywords.User Notifications') }}</span>
                                 </a>
                             </div>
                             <div
                                 class="menu-item {{ request()->is('list/notification/list/store') ? 'active' : '' }}">
                                 <a href="{{ route('storenotlist') }}" class="menu-link">
                                     <span class="menu-text">{{ __('keywords.Store Notifications') }}</span>
                                 </a>
                             </div>
                             <div
                                 class="menu-item {{ request()->is('list/notification/list/driver') ? 'active' : '' }}">
                                 <a href="{{ route('drivernotlist') }}" class="menu-link">
                                     <span class="menu-text">{{ __('keywords.Driver Notifications') }}</span>
                                 </a>
                             </div>
                 ...
                 @endif
                 @if ($admin->reports == 1 || $admin->feedback == 1 || $admin->callback == 1 || $admin->reason == 1)
                     <div class="menu-header">{{ __('keywords.Analytics') }}</div>
                 @endif
                 @if ($admin->reports == 1)
                     <div class="menu-item has-sub {{ request()->is('report/*') ? 'active' : '' }}">
