                ...
                <div class="card">
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('add-varient', $id) }}" class="btn btn-primary p-1 ml-auto"
                                ...
                                @if (count($product) > 0)
                                    ...
                                    @foreach ($product as $products)
                                        <tr>
                                            ...
                                            <td style="float: right">{{ $products->varient_quantity }}</td>
                                            <td> {{ $products->unit }}</td>
                                            <td> {{ $products->description }}</td>
                                            <td class="td-actions text-right">
                                                <a href="{{ route('edit-varient', $products->varient_id) }}" rel="tooltip"
                                                    class="btn btn-success">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a href="{{ route('delete-varient', $products->varient_id) }}"
