            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header card-header-primary">
                        ...
                        <form class="forms-sample" action="{{ route('userNotificationSend') }}" method="post"
                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id='testSelect1'name="user[]" class="form-control" multiple>
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}"><b
                                                    style="color:white !important">{{ $user->name }}
                                                    {{-- (</b>{{ $user->society_name }}<b>) --}}
                                                </b></option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-12">
                                <label class="bmd-label-floating">{{ __('keywords.Image') }}
                                    ({{ __('keywords.It Should Be Less Then 1000 KB') }})</label>
                        ...
                        <br>
                        <button type="submit"
                            class="btn btn-primary pull-center">{{ __('keywords.Send Notification to App Users') }}</button>
