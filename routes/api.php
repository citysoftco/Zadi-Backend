...
Route::group(["middleware" => "check-store-status"], function () {
  ...
  Route::namespace("Api")->prefix('')->group(function () {
    ...
    Route::get('getfirststore', [CategoryController::class, 'getfirststore']);
  ...
  Route::group(['prefix' => 'store', 'namespace' => 'Storeapi'], function () {
